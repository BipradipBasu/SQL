...
--------------------------------------------------------
 ...
 LOB ("RELATION_ATRS_LIST") STORE AS BASICFILE (
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
REM INSERTING into TEST.TBAP_ITEM
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  CREATE INDEX "TEST"."IDX_TBI_1" ON "TEST"."TBAP_ITEM" ("AP_ID") 
...
--------------------------------------------------------
  ...
  CREATE INDEX "TEST"."IDX_TBI_2" ON "TEST"."TBAP_ITEM" ("MAIN_ITEM_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE INDEX "TEST"."IDX_TBI_3" ON "TEST"."TBAP_ITEM" ("PARTITION_KEY", "PARTITION_DATE", "AP_ID", "AP_VERSION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("PARTITION_KEY" NOT NULL ENABLE);
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("ITEM_DEF_ID" NOT NULL ENABLE);
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("ITEM_DEF_VER" NOT NULL ENABLE);
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("STATE" NOT NULL ENABLE);
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("START_DATE" NOT NULL ENABLE);
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("END_DATE" NOT NULL ENABLE);
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("AP_ID" NOT NULL ENABLE);
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("AP_VERSION_ID" NOT NULL ENABLE);
  ALTER TABLE "TEST"."TBAP_ITEM" MODIFY ("PARTITION_DATE" NOT NULL ENABLE);
